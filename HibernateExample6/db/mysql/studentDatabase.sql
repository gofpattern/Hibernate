...
create table STUDENT_COURSE (STUDENT_ID int  ,COURSE_ID int , CONSTRAINT Foreign KEY STUDENT_ID references student(STUDENT_ID),CONSTRAINT Foreign KEY COURSE_ID references student(COURSE_ID));